...
var TxResponse = {
  ...
  fromPartial: function fromPartial(object) {
    var _object$txhash, _object$codespace, _object$code, _object$data, _object$rawLog, _object$logs, _object$info, _object$timestamp;
    var message = createBaseTxResponse();
...
var ABCIMessageLog = {
  ...
  fromPartial: function fromPartial(object) {
    var _object$msgIndex, _object$log, _object$events;
    var message = createBaseABCIMessageLog();
...
var Result = {
  ...
  fromPartial: function fromPartial(object) {
    var _object$data2, _object$log2, _object$events2;
    var message = createBaseResult();
...
var SearchTxsResult = {
  encode: function encode(message) {
    ...
    var _iterator6 = _createForOfIteratorHelper(message.txs),
      _step6;
    try {
